...
r = resolveRoute('claude-3-5-sonnet', withKeys);
ok(r.kind === 'error' && r.provider === 'anthropic', 'claude-* → explicit error (recognized, unsupported in v1) — NOT a silent local sub');
