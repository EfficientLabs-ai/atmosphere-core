...
| **Execute** | `packages/api-shim` daemon (Ollama `qwen2.5:7b` local inference) + `packages/stratos-agent/src/evolution/skill-executor.js` (verify-before-execute wasm skills). | CURRENT |
